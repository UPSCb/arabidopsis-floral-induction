...
#' * Functions
#' 1. plot specific transcript expression
...
#' CHANGEME - Here, you can plot the expression pattern of your transcript of
#' interest. You need to have a list of transcripts in a text file, one transcriptID per line
...
#' Once you have obtained a list of candidate transcripts, you most probably want
#' to annotate them.
#' 
